...
// ─── Remote Images ─────────────────────────────────────────────────────────────
const HERO_IMG        = "https://lh3.googleusercontent.com/aida-public/AB6AXuA_1LnlaGUq7jssoViO4lspz5V8if-rw92q7vumBeYypLDR04TrXK_pOwnCLc-p31MbmwMrt8-5Ir4bSkQblpFPqKxwsWzlwCFs0dkniRGfc1vCfsS95X94y__JZzb0UStVNSTuWwAzliZ66U4_ohOYxo5Y2zXL2pEl37HqrhifGeYSOlPUb2DSTfd3ns1SJl2KDAqonqU3VaUhFjYlRrUaxOekv6tQKg96VEzuhBZShrpZJQR0z20WmeVUJKLYukAavMfXZEtNEtCH";
const IMG_VARIEGATED  = "https://lh3.googleusercontent.com/aida-public/AB6AXuCkWkSIrWUE4uFS2BoGQBf8TGebfHvTVgYdG0MNwGVIjN-4DiTwc6fQxq1c4fTHFWREz8mfyFGzW1cD95Yz4zbWzfqz_mL_aNMxJTre8P47AifT9BNv7XnxIG6-Bh4JG7DLdvowi2OAMRD9XLm2scYWve8KVThdHMMk-IRAtKldKk1vYtIQzopYne-N2sNqwNkDhGP2YlVx1OsLiKHlejG3hpXp0aNxp38aNuKfuSSOmk0r89XjO9CRgBSOGQyOnYVj2Yg5m7R7IzwH";
const IMG_FICUS       = "https://lh3.googleusercontent.com/aida-public/AB6AXuCp8QzeaEZQcuTlcczT3pUWT8Wk7eFYOZnQY3NiUPPURs0O4BKPJ6Bdgbd5qjOcOSOKHgvI34LS9GqdMQUG27QHKasnwmM7l_G5Tte0VYHyemeQ8EMgu33oXMiLkARrjq6Yqz4zCmoQ59S2EqU7rq8z6fHR_2tDWT9HW2TPxl_iA3O7F1R8BlVhBuQdNSVGHtbC64tt1xwolZYZthsmZb9kYR6E4Fj_QPIWtRLAgdi9mz2HzM5ifft14b48O25KP2i4roZ3ZierCu";
const IMG_CALATHEA_O  = "https://lh3.googleusercontent.com/aida-public/AB6AXuBtA0YYPeJGfDCXzi6kN6C1Xyv16Rx7v1fexWcL0mTufqgERxBcOzUpVgsPyf0mCkYqYlaVCVVIxkx6vXRfBByzz2tn2ozXG-H2nso8AUmJgWvyy_7KBeU3GZgd1qh_V-D3xLPl0LCCMD5KmCpYFgRScAFhxBC0wHRtB19nVeF4XFMidk7E-V--XYIdEVfuhT5RbC9LLd3wrls4oykRCMR7ruLEhYXgC9m-G4KQAPuG7avjFtBL-m55X-QqTqMK0ygS8tnH6mAgVS65";
const IMG_SANSEVIERIA = "https://lh3.googleusercontent.com/aida-public/AB6AXuD5N7_9maRxjM8PMkHfGlyQHlmbMvowsN14lZpDMLseX3wzcgQnoqhE0jOAoRL8r6a5sNxmkOxhKq5e2Rbd9zRlt8Q7IzQHeQLpdhfCku70TCvNu9YkCFHhdgVCCviQvSXHAJrutry5DLVwZA1XJT0AB_UZ2ds9o8Uc8Rm6EGJ3vHT6aH4nPmQ6-gr3M3zW78p_B7wkKIyBSRZz4lhA7novyMMzGUB4Y_wiB7F0zrGyX4HAzyiEE6YEZ4-vBWW0db6u6ePN77IXGSBY";
const IMG_PHILODENDRON= "https://lh3.googleusercontent.com/aida-public/AB6AXuAT8BIHISbnHSqXv323VQ4bqTmRpimyDO09nH6lO_SA9LPBcWxfp4gfaKPAygESPmJJFWTxr-VUsr6HZFv0A32RGApFbox3rzgLOkUv2ZD4IKlN8vTOYVnwMiLCW9Hm4NXuFTBQFYfOQ4g8Cr2bw8wK7Tm3hLkC6jcQWF2OyP85Pq_LO46ndoNXeddUkgp9pDPeDJ9RiZEG-FEn5zmmNn0yk3Ew5caWr6Om-6tHG_2nJaWiXr-kt_Jtd3_IwjTon1RsN7pe94CmmlYL";
...
// ──────────────────────────────────────────────────────────────────────────────
function ShopNav({ cartCount, cartBump }) {
...
function FAB() {
  return (
    <MagneticBtn
      ...
      strength={0.5} aria-label="Botanical catalogue"
    >
      <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
        <path d="M17 8C8 10 5.9 16.17 3.82 21.34L5.71 22l1-2.3A4.49 4.49 0 0 0 8 20C19 20 22 3 22 3c-1 2-8 2-8 2C17 8 17 8 17 8z"/>
      </svg>
    </MagneticBtn>
  );
}
    ...
    <>
      ...
      <div style={{ minHeight:"100vh", background:DS.surface, color:DS.onSurface, overflowX:"clip", position:"relative" }}>
        ...
        <div className="relative z-[1]">
          <ShopNav cartCount={cartCount} cartBump={cartBump}/>
