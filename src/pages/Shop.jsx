...
const DS = {
  surface:        "#faf7f2",
  surfaceCont:    "#ffffff",
  surfaceContHi:  "#f2ede3",
  surfaceContLo:  "#faf7f2",
  surfaceContLow: "#faf7f2",
  primary:        "#4a7a45",
  onPrimary:      "#ffffff",
  onSurface:      "#2d2416",
  onSurfaceVar:   "rgba(45,36,22,0.6)",
  outlineVar:     "#c2b89a",
  outline:        "#8b6f47",
};
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden" aria-hidden="true">
      ...
      <div style={{ position:"absolute", top:"-10%", left:"-10%", width:"600px", height:"600px",
        borderRadius:"50%", background:"rgba(212,232,194,0.5)", filter:"blur(130px)",
        animation:"breatheBlob 10s ease-in-out infinite" }} />
      <div style={{ position:"absolute", top:"20%", right:"-15%", width:"500px", height:"500px",
        borderRadius:"50%", background:"rgba(212,232,194,0.4)", filter:"blur(150px)",
      ...
      <div style={{ position:"absolute", bottom:0, left:"40%", width:"400px", height:"400px",
        borderRadius:"50%", background:"rgba(212,232,194,0.3)", filter:"blur(100px)",
      ...
      <div style={{ position:"absolute", inset:0, animation:"lightRay 18s ease-in-out 4s infinite",
        background:"linear-gradient(110deg, transparent 0%, rgba(74,122,69,0.04) 45%, rgba(74,122,69,0.06) 50%, transparent 80%)",
      ...
      <svg className="absolute bottom-10 right-0 opacity-[0.025]" style={{ animation:"sihouetteSway 11s ease-in-out 2s infinite reverse" }}
        ...
        <path d="M100 30 C130 50 170 70 185 110 C195 140 170 185 150 190 C130 195 70 195 50 190 C30 185 5 140 15 110 C30 70 70 50 100 30Z" stroke="rgba(74,122,69,0.4)" strokeWidth="0.5"/>
        <path d="M100 50 L100 180" stroke="rgba(74,122,69,0.25)" strokeWidth="0.3"/>
      </svg>
      ...
      {particles.map(p => (
        <div key={p.id} style={{
          ...
          background:"rgba(74,122,69,0.25)", pointerEvents:"none",
  ...
  return (
    <div
      ...
      style={{
        ...
        position: "relative",
        boxShadow: hovered
          ? "0 12px 40px rgba(0,0,0,0.08), 0 4px 12px rgba(0,0,0,0.05)"
    ...
    >
      ...
      {hovered && (
        <div style={{
          ...
          background: `radial-gradient(circle at ${spotlight.x}% ${spotlight.y}%, rgba(74,122,69,0.06) 0%, transparent 60%)`,
          transition: "none",
        }}/>
      )}
      {/* Glass edge shine */}
      <div style={{
        ...
        background: "linear-gradient(135deg, rgba(255,255,255,0.7) 0%, transparent 40%, transparent 60%, rgba(255,255,255,0.3) 100%)",
      }}/>
      {children}
    </div>
  );
          ...
          <div className="flex items-center gap-3">
            <div className="relative group flex items-center">
              <input 
                ...
                className="rounded-full px-4 py-2 pl-10 text-sm focus:outline-none w-32 focus:w-48 sm:focus:w-64 transition-all duration-300"
                style={{
              ...
              />
              <div className="absolute left-3 pointer-events-none" style={{ color: scrolled ? "#6B7280" : "rgba(255,255,255,0.65)" }}>
                <SearchSVG />
              </div>
            </div>
            <div className="relative" id="cart-target">
              <MagneticBtn
                ...
                style={{
                  background: scrolled ? "rgba(74,122,69,0.07)" : "rgba(255,255,255,0.12)",
...
function HeroSection() {
  ...
  return (
    <section className="relative flex flex-col justify-center items-start pt-20"
      ...
      <div className="relative w-full flex items-center" style={{ minHeight: "600px", maxWidth: "1400px", margin: "0 auto" }}>
        {/* Text with roll-up animation - Left Side */}
        <div className="relative z-20 w-full md:w-1/2 space-y-8 pr-8" style={{ padding: "0 32px 0 32px" }}>
    ...
    <section id="collection" ref={ref} className="mx-auto"
      ...
      <div className={`flex justify-between items-end mb-12 section-reveal ${visible ? "section-reveal--in" : ""}`}>
        <div className="space-y-2">
          <h2 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"40px", fontWeight:600, color:DS.onSurface, letterSpacing:"-0.01em" }}>
            Current Collection
          </h2>
          <p style={{ color:DS.onSurfaceVar, fontFamily:"'DM Sans',sans-serif", fontSize:"16px" }}>
            Rare plants, grown in our Portland greenhouse.
          </p>
        </div>
        <MagneticBtn 
          className="p-4" 
          style={{ border:`1px solid rgba(74,122,69,0.3)`, color:DS.onSurface }} 
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          ...
          >
            <div style={{ position:"relative", zIndex:2 }}>
              <span className="font-semibold uppercase tracking-[0.2em]"
                style={{ color:DS.primary, fontSize:"12px", fontFamily:"'DM Sans',sans-serif" }}>
                {variegated.badge}
              </span>
              <h3 className="mt-2" style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"40px", fontWeight:600, color:DS.onSurface }}>
                {variegated.name}
              </h3>
              <p className="max-w-xs mt-4" style={{ color:DS.onSurfaceVar, fontFamily:"'DM Sans',sans-serif", fontSize:"16px" }}>
            ...
            <div style={{ position:"absolute", right:"-40px", bottom:"-40px", width:"55%", pointerEvents:"none", zIndex:1,
              animation:"plantFloat 6s ease-in-out infinite", filter:"drop-shadow(0 16px 32px rgba(74,122,69,0.15))" }}>
            ...
            <div style={{ position:"relative", zIndex:2 }} className="flex items-center gap-4">
              <span style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"24px", fontWeight:600, color:DS.primary }}>
        ...
        <div className={`md:col-span-4 stagger-reveal ${visible ? "stagger-reveal--in" : ""}`} style={{ "--delay":"100ms" }}>
          <TiltCard intensity={10} onClick={() => onSelectPlant(ficus)}
            ...
            <div>
              <span className="font-semibold uppercase tracking-[0.2em]"
                style={{ color:DS.onSurfaceVar, fontSize:"12px", fontFamily:"'DM Sans',sans-serif" }}>
                {ficus.badge}
              </span>
              <h3 className="mt-2" style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"24px", fontWeight:600, color:DS.onSurface }}>
                {ficus.name}
              </h3>
            </div>

            <div style={{ padding:"32px 0", display:"flex", justifyContent:"center",
              animation:"plantFloat 5s ease-in-out 1s infinite", filter:"drop-shadow(0 10px 20px rgba(74,122,69,0.12))" }}>
            ...
            <div className="flex justify-between items-center">
              ...
              <MagneticBtn
                className="w-10 h-10 flex items-center justify-center rounded-full border border-brand-moss/30"
        ...
        {[calatheaO, sansevieria, philodendron].map((plant, i) => (
          <div key={plant.id} className={`md:col-span-4 stagger-reveal ${visible ? "stagger-reveal--in" : ""}`}
            ...
            <TiltCard intensity={14} onClick={() => onSelectPlant(plant)}
              ...
              <div style={{ position:"relative", flexShrink:0, animation:`plantFloat ${5+i}s ease-in-out ${i*0.7}s infinite` }}>
                <img src={plant.imageUrl} alt={plant.name}
                  style={{ width:"96px", height:"96px", objectFit:"cover", borderRadius:"12px",
                    boxShadow:"0 4px 16px rgba(0,0,0,0.06)", transition:"transform 0.4s ease" }}/>
                {/* glow dot badge */}
              ...
              <div>
                <span style={{ color:DS.primary, fontSize:"10px", fontFamily:"'DM Sans',sans-serif", fontWeight:600, letterSpacing:"0.15em", textTransform:"uppercase" }}>
                  {plant.badge}
                </span>
                <h4 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"16px", fontWeight:600, color:DS.onSurface, marginTop:"4px" }}>
                  {plant.name}
                </h4>
                <div className="mt-1 flex items-center justify-between gap-4">
                  <span className="font-bold" style={{ color:DS.primary, fontFamily:"'DM Sans',sans-serif" }}>
                    {plant.priceDisplay}
                  </span>
                  <MagneticBtn
  ...
  return (
    <section ref={sectionRef} style={{ maxWidth:"1280px", margin:"0 auto", padding:"0 64px 80px" }}>
      <div className="rare-header flex justify-between items-end mb-12">
        <div className="space-y-2">
          <span style={{ color:DS.primary, fontSize:"12px", fontFamily:"'DM Sans',sans-serif", fontWeight:600, letterSpacing:"0.2em", textTransform:"uppercase" }}>
            Exclusive
          </span>
          <h2 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"40px", fontWeight:600, color:DS.onSurface, letterSpacing:"-0.01em" }}>
            Rare Specimens
          ...
          <div style={{ display:"flex", gap:"8px" }}>
            {filterOptions.map((f,i) => {
              ...
              <button key={f} onClick={() => setActiveFilter(f)} style={{
                padding:"8px 16px", fontSize:"12px", fontFamily:"'DM Sans',sans-serif", fontWeight:500,
          ...
          <div key={plant.id} className="rare-card">
            <TiltCard intensity={12} onClick={() => onSelectPlant(plant)}
              ...
              <div style={{ height:"240px", position:"relative", overflow:"hidden",
                background:"linear-gradient(135deg, rgba(255,255,255,0.9) 0%, rgba(250,247,242,0.85) 100%)" }}>
                <img src={plant.image} alt={plant.name}
                  style={{ width:"100%", height:"100%", objectFit:"contain", objectPosition:"center",
                    animation:`plantFloat ${5+i}s ease-in-out ${i*0.5}s infinite`,
                    filter:"drop-shadow(0 8px 16px rgba(74,122,69,0.12))", transition:"transform 0.5s ease",
                    padding:"24px" }}/>
                {/* Rarity badge */}
              ...
              <div style={{ padding:"24px", flex:1, display:"flex", flexDirection:"column", gap:"8px" }}>
                <span style={{ color:DS.onSurfaceVar, fontSize:"11px", fontFamily:"'DM Sans',sans-serif", textTransform:"uppercase", letterSpacing:"0.1em" }}>
                  {plant.category}
                </span>
                <h4 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"18px", fontWeight:600, color:DS.onSurface }}>
                  {plant.name}
                </h4>
                <div className="flex items-center justify-between mt-auto pt-3"
                  style={{ borderTop:"1px solid rgba(60,74,66,0.3)", marginTop:"8px" }}>
                  <span style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"20px", fontWeight:600, color:DS.primary }}>
                    {plant.priceDisplay}
                  </span>
                  <MagneticBtn
    ...
    <section ref={sectionRef} style={{
      ...
      <div style={{ maxWidth:"1280px", margin:"0 auto", padding:"0 64px" }}>
        <div className="best-header flex justify-between items-end mb-12">
          ...
          <button type="button" onClick={() => window.scrollTo({top:0, behavior:'smooth'})} style={{ color:DS.primary, fontFamily:"'DM Sans',sans-serif", fontSize:"14px", fontWeight:600,
    ...
    <section ref={sectionRef} style={{ maxWidth:"1280px", margin:"0 auto", padding:"80px 64px" }}>
      <div className="new-header flex justify-between items-end mb-12">
        <div>
          ...
          <h2 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"40px", fontWeight:600, color:DS.onSurface, letterSpacing:"-0.01em", marginTop:"8px" }}>
            New Arrivals
          </h2>
        </div>
        <button type="button" onClick={() => window.scrollTo({top:0, behavior:'smooth'})} style={{ color:DS.primary, fontFamily:"'DM Sans',sans-serif", fontSize:"14px", fontWeight:600,
    ...
    <section ref={sectionRef} className="relative overflow-hidden" style={{
      ...
      <div className="newsletter-content max-w-screen-xl mx-auto text-center space-y-12"
        ...
        <div className="max-w-2xl mx-auto space-y-4">
          ...
          <p style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"18px", lineHeight:"28px", color:DS.onSurfaceVar }}>
            Receive exclusive access to monthly specimen drops and architectural botanical guides.
          </p>
        </div>
        {subscribed ? (
          <p style={{ color:DS.primary, fontFamily:"'DM Sans',sans-serif", fontSize:"18px" }}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col md:flex-row max-w-xl mx-auto gap-4">
            <input type="email" value={email} onChange={(e) => setEmail(e.target.value)}
              ...
              style={{ background:DS.surface, border:`1px solid ${DS.outlineVar}`, color:DS.onSurface, fontFamily:"'DM Sans',sans-serif" }}
            ...
            <MagneticBtn type="submit" className="h-14 px-10 font-bold text-sm"
              style={{ background:DS.primary, color:DS.onPrimary, fontFamily:"'DM Sans',sans-serif",
    ...
    <footer style={{ background:DS.surfaceContLow, padding:"80px 64px", borderTop:`1px solid rgba(60,74,66,0.2)` }}>
      <div className="mx-auto grid grid-cols-1 md:grid-cols-4 gap-6" style={{ maxWidth:"1280px" }}>
        <div className="space-y-6">
          <a href="#shop" style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"24px", fontWeight:600, color:DS.primary }}>Planto</a>
          <p style={{ color:DS.onSurfaceVar, fontFamily:"'DM Sans',sans-serif", fontSize:"16px", lineHeight:"24px", marginTop:"16px" }}>
        ...
        {[["Collection",["Best Sellers","Rare Specimens","Care Accessories","Gift Cards"]],
          ...
          <div key={title}>
            <h4 className="mb-6 uppercase tracking-widest" style={{ color:DS.onSurface, fontFamily:"'DM Sans',sans-serif", fontSize:"12px", fontWeight:600 }}>{title}</h4>
            <ul className="space-y-4" style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"16px" }}>
              {items.map(item => (
        ...
        <div>
          <h4 className="mb-6 uppercase tracking-widest" style={{ color:DS.onSurface, fontFamily:"'DM Sans',sans-serif", fontSize:"12px", fontWeight:600 }}>Connect</h4>
          ...
          <p className="mt-8" style={{ color:DS.onSurfaceVar, fontFamily:"'DM Sans',sans-serif", fontSize:"12px", letterSpacing:"0.05em" }}>
  ...
  return (
    <section ref={ref} style={{ maxWidth:"1280px", margin:"0 auto", padding:"80px 64px" }}>
      <div className={`mb-12 section-reveal ${visible ? "section-reveal--in" : ""}`}>
        <h2 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"40px", fontWeight:600, color:DS.onSurface }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {results.map((plant, i) => (
             <TiltCard key={i} intensity={8} onClick={() => onSelectPlant(plant)}
                ...
                <h4 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:"20px", fontWeight:600, color:DS.onSurface }}>{plant.name}</h4>
                <div className="flex items-center justify-between mt-auto pt-4">
                  ...
                  <MagneticBtn style={{ ...glass, color:DS.primary, padding:"8px 16px", fontSize:"12px", fontFamily:"'DM Sans',sans-serif", fontWeight:600 }}
                    onClick={(e) => { e.stopPropagation(); onAddToCart(plant, e); }}>
                    ADD
                  </MagneticBtn>
                </div>
