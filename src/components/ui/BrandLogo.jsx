  ...
  return (
    <span className={`inline-flex items-center ${s.gap} ${className}`}>
      <img
        src={mainLogo}
        alt=""
        className={`${s.img} object-contain drop-shadow-[0_2px_12px_rgba(109,184,122,0.55)] brightness-[1.2]`}
        aria-hidden="true"
      />
      <span className={`text-white font-bold ${s.text} tracking-tight leading-none whitespace-nowrap`}>
