      ...
      >
        ...
        <div className="flex flex-col sm:flex-row">
          ...
          >
            {plant.imageUrl ? (
              ...
              <img
                ...
                style={{ filter: "drop-shadow(0 12px 20px rgba(74,122,69,0.18))" }}
              />
            )}
          </div>
          ...
          <div className="sm:w-1/2 p-6 sm:p-8 flex flex-col gap-5">
            ...
            <p className="text-2xl font-bold" style={{ color: "#4a7a45", fontFamily: "Geist, sans-serif" }}>
              {priceDisplay}
            </p>

            <p className="text-sm leading-relaxed" style={{ color: "rgba(45,36,22,0.6)" }}>
              {details.description}
            </p>
            ...
            >
              {[
                ...
                <div key={type} className="flex flex-col items-center gap-2 text-center">
                  <div style={{ color: "#4a7a45", opacity: 0.8 }}>
                    <CareIcon type={type} />
                  </div>
                  <span
                    className="text-xs font-medium tracking-widest uppercase"
                    style={{ color: "rgba(45,36,22,0.6)" }}
                  >
                    {label}
                  </span>
