    ...
    <section id="contact" ref={sectionRef} className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h2 className="contact-header font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif", fontSize: "clamp(32px, 5vw, 52px)", fontStyle: "italic", color: "#1B4332", lineHeight: 1.1 }}>
            Get in Touch
          </h2>
          <p className="contact-header text-brand-dark/55 text-base sm:text-lg max-w-2xl mx-auto" style={{ fontFamily: "'DM Sans', sans-serif", lineHeight: 1.75 }}>
            Have questions about our plants or need care advice? We're here — and we actually reply.
          </p>
        </div>
          ...
          <div className="contact-info mt-10 pt-8 border-t border-brand-bark/12">
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
              ...
              <div>
                ...
                <a href="tel:+1234567890" className="text-brand-dark/55 hover:text-brand-primary transition-colors text-sm">
                  +1 (234) 567-890
                </a>
              </div>
              <div>
