  ...
  return (
    ...
    >
      <div className="glass py-12 sm:py-14 px-6 sm:px-8 lg:px-12">
        <h2 className="text-brand-dark text-2xl sm:text-3xl md:text-4xl font-bold text-center mb-10 sm:mb-12">
        ...
        <div className="relative flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-0">
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <h3 className="text-brand-dark text-lg font-bold mb-2">{step.title}</h3>
              <p className="text-brand-dark/50 text-sm leading-relaxed max-w-[220px]">{step.desc}</p>
            </div>
          ))}
        </div>
      </div>
